...
for  i = 1:numseg
    ...
    NEvents1 = 100;  %% The number of events for channel 1
    NEvents2 = 30; %% The number of events for channel 2
    
    L = 92; %% The length in seconds
  
  
    Max1 = 1.1;    %% The maximum duration in seconds for channel1
    Min1 = 0.5;  %% The minimum duration in seconds for channel1
    
    Max2 = 1.1;    %% The maximum duration in seconds for channel2
    Min2 = 0.5; %% The minimum duration in seconds for channel2
