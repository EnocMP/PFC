...
static t_class *communications_class; //create communications class
...
/***************************METHODS***************************/
void communications_bang (t_communications *x) {
...
void *communications_new(	//Constructor function
		...
		//the upper boundary and the step width
{
 ...
 #endif
  t_communications *x = (t_communications *)pd_new(communications_class); 	
  // creates (casts) a new pointer to a t_communications
...
void communications_setup(void) {
	communications_class=class_new	//Create the new class
		(gensym("communications"),	//symbolic name of the class
		(t_newmethod)communications_new,//constructor (called when PD 
					   //instantiates a new object)
		0,			//destructor(never in this case)
		sizeof(t_communications),	//logic space of the object
	...
	class_addbang(		//new method 
		communications_class, 	//belonging class
		communications_bang); 	//adding the bang method


	//class_sethelpsymbol(communications_class, gensym("help-communications")); 
//help location for the communications class
}
